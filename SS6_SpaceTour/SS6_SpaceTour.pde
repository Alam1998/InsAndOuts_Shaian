// Shaian Khan, title: SS6_SpaceTour. 
...
float[] x= {285, 250, 250, 250, 200, 200}; // Created an array.
...
void Spaceship() {  
  ...
  fill   (100);
triangle(x[0], 260, x[1], 230, x[2], 290); //spaceship wings.


  fill   (100);
triangle(x[3], 275, x[4], 275, x[5], 230); //spaceship back
